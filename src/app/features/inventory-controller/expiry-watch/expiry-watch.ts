    ...
    <div class="space-y-5">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
          <select
            ...
            class="text-sm border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white"
          >
          ...
          <button
            (click)="loadData()"
            class="bg-teal-600 text-white px-3 py-2 rounded-lg text-sm hover:bg-teal-700 transition-colors font-medium flex items-center gap-1.5"
          >
      ...
      <div class="grid grid-cols-3 gap-3">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
          <p class="text-xs font-semibold text-blue-600 uppercase tracking-wide">Notice 31+ days</p>
          <p class="text-2xl font-bold text-blue-700 mt-1">{{ noticeCount() }}</p>
        </div>
      </div>
                  ...
                  <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-4 py-3">
                      <span class="font-bold text-base"
                        [class]="watch.daysToExpire <= 7 ? 'text-red-600' : watch.daysToExpire <= 30 ? 'text-amber-600' : 'text-blue-600'">
...
export class ExpiryWatchComponent implements OnInit {
  ...
  loadData() {
    ...
    this.icService.getNearExpiryWatches(this.selectedDays()).subscribe({
